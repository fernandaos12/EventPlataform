            ...
            <div className="flex-1">
                ...
                gerada pela plataforma no nosso front-end utilizando Apollo Client.
                    ...
                    <div className="flex items-center gap-4 mt-6">
                        ...
                        src="https://github.com/fernandaos12.png" alt=""/>
                        
                        <div className="leading-relaxed">
                            <strong className="font-bold text-2xl block">Fernanda Oliveira</strong>
                            <span
                            className="text-gray-200 text-sm block">Professor do Evento</span>
                        </div>
                    </div>
            </div>
