...
export function Subscribe(){
    ...
    return(
        <div className="min-h-screen bg-bgblur bg-cover bg-no-repeat flex flex-col items-center">
          
          <div className="ww-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
            <div className="max-w-[640px]">
                ...
                <p className="mt-4 text-gray-300 leading-tight">
            ...
            <img src="/src/assets/coldmockup.png"/>
        </div>
    )
}